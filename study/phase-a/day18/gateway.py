...
ADMISSION_BUDGET = int(KV_CAPACITY_TOKENS * TARGET_UTILIZATION)  # ~124,150 tokens
...
RATE_LIMIT_REQUESTS = 10_000   # raised for load testing (default 60)
RATE_LIMIT_TOKENS = 50_000_000 # raised for load testing (default 100k)
...
async def startup():
    ...
    print(f"[gateway] Budget: {ADMISSION_BUDGET:,} tokens ({TARGET_UTILIZATION*100:.0f}% of {KV_CAPACITY_TOKENS:,})")
